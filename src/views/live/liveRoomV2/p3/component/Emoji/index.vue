<template>
  <div class="Emojs" v-bind="$attrs" v-on="$listeners">
    <div title="表情" @click="onClick">
      <!-- <svg-icon icon-class="liveToolEmotion" class-name="svgicon" style="stroke:currentColor" /> -->
      <img src="~@/assets/image/liveRoom/emotion_icon.png" alt="" class="liveToolEmotion" />
    </div>
