<template>
  ...
  >
    ...
    <div slot="footer" class="ss-material-box-bottom">
      ...
      <!-- <el-button  size="small" :loading="loading" type="primary" @click="toRegisterSetting">预约设置</el-button> -->
      <el-button v-else size="small" :loading="loading" type="primary" @click="onhandleAddLiveRoom">添加直播间</el-button>
...
import addLiveRoomDialog from '@/views/live/liveRoomV2/components/liveToolReservation/addLiveRoomDialog'
export default {
  filters: {
    filterTime(val) {
      if (!val) {
