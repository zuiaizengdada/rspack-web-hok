...
import { planWatchUserImport } from '@/api/liveRoom/detail.js'
...
export default {
  ...
  methods: {
    ...
    getImportFileUrl() {
      ...
      // newWin.location.href = 'https://oss.hokkj.cn/planuser.xls' // 成功 重定向到目标页面
      newWin.location.href = 'https://hok-o.oss-cn-beijing.aliyuncs.com/%E8%AE%A1%E5%88%92%E7%9C%8B%E6%92%AD%E7%94%A8%E6%88%B7%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xls' // 成功 重定向到目标页面
