              ...
              <el-radio-group v-model="form.showQuotaRadio">
                <div class="showQuotaRadio-container">
                  ...
                  <div class="showQuotaRadio-itemcenter">
                    <el-radio :label="1">
                      <span style="line-height: 32px;">限名额2&nbsp;</span>
                      <el-input-number v-model="form.showQuotaVal" placeholder="最大输入999" style="width: 152px" size="small" @focus="() => { form.showQuotaRadio = 1}" @input="delShowQuotaNumber($event, form)">
