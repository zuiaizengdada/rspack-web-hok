<template>
  ...
  >
    ...
    <el-checkbox v-model="columns[1].visible" :disabled="columns[1].disable">{{ columns[1].label }}</el-checkbox>
...
export default {
  ...
  mounted() {
    ...
    this.$dragging.$on('dragged', (res) => {
      console.log(res)
      localStorage.setItem('tableColumns_liveDataStatistics_liveDataKanban', JSON.stringify(this.columns))
