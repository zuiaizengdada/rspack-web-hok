        ...
        <el-tooltip v-if="chatUser.type === 2 && liveRoomDetail.liveModel === 'AI_LIVE' && [1, 2, 3].includes(liveRoomDetail.status)" effect="dark" content="设置" placement="top">
          <el-dropdown trigger="click" placement="top" @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              <!-- <el-dropdown-item command="onhandlePeopleNumber"><svg-icon class-name="toolsIcon m-r-10" icon-class="renshutiaozheng" />加热直播间</el-dropdown-item> -->
              ...
              <!-- <el-dropdown-item v-if=" scriptSetting.isRelateScript && scriptSetting.scriptInteractStatus === 2 && [1, 2, 3].includes(liveRoomDetail.status) && havBtnOld('web:liveRoom:start')" command="onhandleStart">
                <svg-icon class-name="toolsIcon m-r-10" icon-class="qidonghudong" />启动互动</el-dropdown-item> -->
              <!-- <el-dropdown-item v-if=" scriptSetting.isRelateScript && [1, 2, 3].includes(liveRoomDetail.status) && havBtnOld('web:liveRoom:restart')" command="onhandleRestart">
                <svg-icon class-name="toolsIcon m-r-10" icon-class="scriptInteractRestart" />重启互动</el-dropdown-item> -->
              <!-- <el-dropdown-item v-if=" scriptSetting.isRelateScript && [1, 2, 3].includes(liveRoomDetail.status)" command="onhandleDelayed">
                <svg-icon class-name="toolsIcon m-r-10" icon-class="yanshihudong" />延时互动</el-dropdown-item> -->
