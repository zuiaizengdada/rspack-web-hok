<template>
  <div class="indicatorSettings">
    ...
    <div class="indicatorSettingsContent m-t-10">
      ...
      <el-input-number v-model="form.attendClassTime" :max="180" :min="0" :disabled="!ifEdit" size="small" style="width: 120px" class="m-l-10 m-r-10" />
      <span>分钟的数据</span>
    </div>
    <div class="indicatorSettingsContent m-t-10">
      <el-select v-model="form.attendCondition" placeholder="请选择" size="small" :disabled="!ifEdit">
        <el-option
    ...
    <div class="indicatorSettingsContent m-t-10">
      ...
      <el-input-number v-model="form.attendPlaybackTime" :max="180" :min="0" :disabled="!ifEdit" size="small" style="width: 120px" class="m-l-10 m-r-10" />
      <span>分钟的数据</span>
    </div>
    <div class="indicatorSettingsTitle m-t-20">完课数定义</div>
    <div class="indicatorSettingsContent m-t-10">
      <span>在直播间中观看时长大于等于</span>
      <el-input v-model="form.finishClassTime" :disabled="!ifEdit" size="small" style="width: 120px" class="m-l-10 m-r-10" @input="(e) => delNumber(e, 'finishClassTime')" />
      <span>分钟的数据</span>
    </div>
    <div class="indicatorSettingsTitle m-t-20">回放定义</div>
    <div class="indicatorSettingsContent m-t-10">
      <span>用户累计观看回放时长大于等于</span>
      <el-input v-model="form.playbackTime" :disabled="!ifEdit" size="small" style="width: 120px" class="m-l-10 m-r-10" @input="(e) => delNumber(e, 'playbackTime')" />
      <span>分钟的数据</span>
    </div>
