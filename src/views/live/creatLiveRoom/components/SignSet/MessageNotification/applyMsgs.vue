    ...
    <div v-for="(value,index) in list.applyMsgs" :key="index" class="applyMsgs-container">
      <div class="applyMsgs-item">
        ...
        <div class="order-time-box">
          <el-select v-model="value.timeType" placeholder="请选择模版" size="small" class="input-with-select input-with-select-chang" @change="optionsTimeChange($event,index)">
