  ...
  <div class="pageWrap">
    ...
    <div v-loading="loading" class="pageContent">
      ...
      >
        ...
        <el-table-column prop="discountMethod" label="优惠券类型" align="center">
          <template slot-scope="{ row }">
        ...
        <el-table-column prop="receiveCount" label="已领取张数" align="center" />
        <el-table-column prop="receiveUserCount" label="已领取人数" align="center" />
        <el-table-column prop="applyCount" label="使用人数" align="center" />
        <el-table-column prop="notApplyCount" label="未使用人数" align="center" />
        <el-table-column prop="useCount" label="使用优惠券笔数" align="center" />
        <el-table-column prop="discountsFee" label="使用优惠券金额" align="center">
          <template slot-scope="{ row }">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      oneLiveRoomReportCoupon(data).then(res => {
        this.dataCount = {
