<template>
  <div class="player">
    <div class="videoTitle">
      <el-tooltip v-if="videoObj.version>0" class="item" effect="dark" :content="`时间：${videoObj.videoCreateTime}`" placement="top-start">
        <span v-if="videoObj.version>0" class="video-version">V{{ videoObj.version }}</span>
      </el-tooltip>
      <span :title="videoName">{{ videoName }}</span>
    </div>
