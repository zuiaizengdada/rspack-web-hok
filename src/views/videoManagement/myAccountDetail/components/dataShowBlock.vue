<template>
  <div>
    <div class="top_search">
      <div class="search_title">
        ...
        <div class="right_time_choose-s">
          <AppDatepicker
            :show="[1, 7,14,30]"
            :default="searchForDetail.active"
            :size="searchForDetail.size"
            :search="searchForDetail"
      ...
      <div class="flex flex-middle top-data">
        ...
        <div class="data_show_row flex flex-1 flex-wrap">
          <div class="flex flex-column flex-middle  flex-1" style="border-right: 1px solid #E2E2E2;">
            <div class="dsr_block" :class="active === 7?'activeClass':''">
            ...
            <div class="flex m-t-18">
              <div class="dsr_block" :class="active === 8?'activeClass':''">
              ...
              <div class="dsr_block" :class="active === 9?'activeClass':''">
          ...
          <div class="flex flex-column flex-middle  flex-1">
            <div class="dsr_block" :class="active === 10?'activeClass':''">
            ...
            <div class="flex m-t-18">
              <div class="dsr_block" :class="active === 11?'activeClass':''">
              ...
              <div class="dsr_block" :class="active === 12?'activeClass':''">
    ...
    <div class="data-line-echart m-t-20">
...
import { getDataOverview, lineChartDetail, getOrderData, lineChartDetailSingle } from '@/api/videoManagement/dataApi'
...
export default {
  ...
  data() {
    return {
      searchForDetail: {
        size: 'mini',
        active: 7,
        time: [moment().subtract(7, 'day').format('YYYY-MM-DD'), moment().subtract(1, 'day').format('YYYY-MM-DD')]
      },
      tabList,
      tabIndex: '1',
      dataObj: {
  ...
  mounted() {
    if (this.$route.query.startTime && this.$route.query.endTime) {
      this.$set(this.searchForDetail, 'active', '')
      this.$set(this.searchForDetail, 'time', [this.$route.query.startTime, this.$route.query.endTime])
    }
  ...
  methods: {
    ...
    handleChange() {
      this.showThisData(this.paramForm.paramType)
    },
    changeChooseItem(num) {
      this.active = num
      this.showThisData(num)
    },
    checkList(value) {
      this.tabIndex = value
    ...
    showThisData(num, id) {
      ...
      params.platformAccountId = id || this.platformAccountId
      params.paramType = num
      console.log('this.paramsForm00:', this.paramForm)
      if (num < 7) {
    ...
    timeChange(val) {
      ...
      this.searchForDetail = val
      const params = {
        platformAccountId: this.platformAccountId,
        startTime: this.searchForDetail.time[0],
        endTime: this.searchForDetail.time[1]
      }
      console.log(params, '搜索条件params')
      this.$nextTick(() => {
