  ...
  <div>
    <div class="page_header">
      <div class="page_header_title">
        <span class="pointer" @click="$router.push({ path: '/shop/video' })">视频</span>
        /
        <span>视频详情</span>
      </div>
      ...
      <div v-loading="loading" class="page_header_detail">
        ...
        <div class="page_header_detail_content">
          ...
          <div class="operate">
            ...
            <el-button v-permission="['web:goods:share', permsList]" v-share="`pages/subpage/share/index?id=${$route.params.id}&type=1`">分享</el-button>
