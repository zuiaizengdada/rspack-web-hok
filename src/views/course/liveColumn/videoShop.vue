  ...
  <div class="content">
    ...
    >
      <div id="ss-dialog-content" v-loading="dialog.loading" class="ss-dialog-content">
        <el-form ref="dynamicValidateForm" :model="dynamicValidateForm" label-width="150px" class="demo-dynamic">
          <el-form-item
            label="店铺名称"
            prop="thirdShopName"
            :rules="{
...
export default {
  ...
  data() {
    return {
      type: 10, // 1：抖店 2：快手 3：其他 4:微店 7: 小鹅通 10：视频号小店 11：枫页小店
      loading: false,
      current: 1,
      size: 10,
      contentName: '',
