  ...
  <div>
    <div class="page_header">
      <div class="page_header_title">
        <span class="pointer" @click="$router.push({ path: '/shop/packageCollegeColumn/list' })">大专栏</span>
        /
        <span>大专栏详情</span>
      </div>
      ...
      <div v-loading="loading" class="page_header_detail">
        ...
        <div class="page_header_detail_content">
          ...
          <div class="operate">
            <el-button v-permission="['system:goods:edit', permsList]" @click="gotoEdit(detail)">编辑</el-button>
            <el-button v-permission="['web:goods:share', permsList]" v-share="`pages/subpage/share/index?id=${detail.goodsId}&type=1`">分享</el-button>
...
export default {
  ...
  methods: {
    ...
    gotoEdit(row) {
      ...
      // this.$router.push({ path: `/course/collegeColumnEdit/${row.goodsId}` })
    },
    // 删除
    del(row) {
      this.$delModal({
