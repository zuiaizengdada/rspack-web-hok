  ...
  <div>
    <div class="page_header">
      <div class="page_header_title">
        <span class="pointer" @click="$router.push({ path: '/shop/image' })">图文</span>
        /
        <span>图文详情</span>
      </div>
      ...
      <div v-loading="loading" class="page_header_detail">
        ...
        <div class="page_header_detail_content">
          ...
          <div class="operate">
            ...
            <el-button v-permission="['web:goods:share', permsList]" v-share="`pages/subpage/share/index?id=${id}&type=1`">分享</el-button>
...
export default {
  ...
  created() {
    this.activeName = this.$route.query.type || 'recommend'
  ...
  methods: {
    ...
    gotoEdit(row) {
      ...
      // this.$router.push({ path: `/course/imageEdit/${row.goodsId}` })
    },
    // 删除
    del(row) {
      this.$delModal({
