      ...
      <div class="m-t-20">
        ...
        <!-- <el-form-item label="图文资源">
          <div>
            ...
            <div v-else>
              <el-image :src="form.materialVo.materialUrl" class="image_poster" style="width: 200px;height: 112px; " fit="contain" :preview-src-list="[form.materialVo.materialUrl]" />
            </div>
        ...
        <el-form-item label="图文详细" prop="content">
          <AppUEditor v-model="form.content" @change="change" />
        </el-form-item>
      ...
      axios
        .all(
          [
            getTeacherList(),
            getCatalogueList(),
            getGoodsDetail(this.$route.params.id)
          ],
          getPlatformCatalogueList()
        )
        .then(res => {
          ...
          this.goodsGroupingOption = res[1].data
