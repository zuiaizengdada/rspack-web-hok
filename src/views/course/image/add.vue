<template>
  <div v-loading="loading" class="page_wrap">
    <div class="header">
      <span class="pointer" @click="$router.push({ path: 'list' })">图文</span>
      > 新建图文
    </div>
    <el-form
      ref="form"
    ...
    >
      ...
      <div class="m-t-20">
        <el-form-item label="图文名称" prop="contentName">
          <el-input
        ...
        <!-- <el-form-item label="图文资源">
          <div>
            <div v-if="!form.materialVo.materialUrl" class="image_poster" style="width: 200px;height: 112px" @click="getImage()">
              <i class="el-icon-plus" />
              <span>选择图文</span>
            </div>
            <div v-else>
              <AppMyImage
                :src="form.materialVo.materialUrl"
                ...
                @close="delMaterialUrl"
                @success="changeMaterialUrl"
              />
            </div>
            <div class="tips m-t-20">
              <div>图文封面是指图文展示的图片，建议尺寸750*422或比例16：9，</div>
        ...
        <el-form-item label="封面图" prop="contentUrl">
          ...
          <div class="tips m-t-20">
            ...
            <div>建议尺寸750*560，小于500K的JPG格式图片</div>
          </div>
        </el-form-item>
        ...
        <el-form-item v-if="form.fragmentTrialFlag === 0" label="试看内容">
          <AppUEditor
            ref="AppUEditor2"
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        goodsId: '', // 图文音频图文id
        goodsType: 0, // 0:图片,1:音频，2视频,3专栏，4大专栏
  ...
  methods: {
    ...
    _addGoods() {
      ...
      const params = {
        ...
        contentUrl,
        content: this.$refs.AppUEditor1
          ? this.$refs.AppUEditor1.getContent()
          : '',
        trialContent: this.$refs.AppUEditor2
          ? this.$refs.AppUEditor2.getContent()
          : ''
      }
