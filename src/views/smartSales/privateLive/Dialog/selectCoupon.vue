<template>
  ...
  >
    ...
    <div v-loading="loading" class="sendCoupon overflowOuto relative">
    ...
    <div slot="footer" class="ss-material-box-bottom">
      <el-row class="cancelBtn">
        <el-button size="small" :loading="loading" type="primary" @click="send">确定</el-button>
...
export default {
  ...
  methods: {
    send() {
      ...
      this.visible = false
      this.success && this.success(this.selectCoupon)
    },
    // 点击领取记录按钮
    anhandleRecord() {
      Dialog.open({
