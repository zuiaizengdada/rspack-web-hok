<template>
  ...
  >
    <div class="purchaseRecord">
      <div><el-checkbox v-model="search.existInviteTeacher" class="m-b-10" @change="searchFn">仅查看邀约学员</el-checkbox></div>
      <div class="search m-b-20">
        ...
        <selectTelEmail v-model="search.userInfo" class="m-r-10" size="small" width="170px" @onChange="searchFn" />
        <label
          class="searchLabel"
        >下单时间
          <el-date-picker
...
import MyStatus from '../p3/liveRoomSeeting/MyStatus.vue'
