<template>
  ...
  <div class="userRecords">
    <div class="search">
      ...
      <el-button v-permission="['btn:liveDetail:userRecordsExport', permsList]" class="fr btn_primary" size="small" @click="onhandleExport">导出记录</el-button>
    </div>
...
<script>
import { getUserRecordPageV2, userRecordPageImport, getLiveRoomUserInfoByName, recordCluePull } from '@/api/liveRoom/index.js'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getUserRecordPageV2(params).then(res => {
