        ...
        <el-form ref="search" :model="search" :inline="true" size="small">
          ...
          <el-form-item label="讲师">
            <el-select
              ...
              @change="onhandleTearchChange"
            >
              <el-option label="真人讲师" value="PERSON_LIVE" />
              <el-option label="视频讲师" value="AI_LIVE" />
            </el-select>
            <el-select
              v-if="liveModel === 'PERSON_LIVE'"
              v-model="search.realityTeacherUserId"
              class="w-160 filter_teacherSelect"
              filterable
              placeholder="请选择讲师"
              clearable
            >
          ...
          <el-form-item label="助教" label-width="40px">
            <el-select
              v-model="search.tutorTeacherUserId"
              class="w-160"
              filterable
              placeholder="请选择助教"
              clearable
