    ...
    >
      ...
      <template v-slot:operate="{ scope }">
        <template v-if="canshowTools(scope.row)">
          <el-button
            v-permission="['btn:myliveRoomlist:detail', permsList]"
            type="text"
          ...
          <el-button
            ...
            v-permission="['btn:myliveRoomlist:inviteLive', permsList]"
            type="text"
            style="margin-right: 10px; margin-left: 0px"
          ...
          <el-button
            v-if="canShowGotoLiveRoom(scope.row)"
            v-permission="['btn:myliveRoomlist:enterLive', permsList]"
            type="text"
            style="margin-right: 10px; margin-left: 0px"
        ...
        <el-button
          v-permission="['btn:myliveRoomlist:copyLive', permsList]"
          type="text"
          style="margin-right: 10px; margin-left: 0px"
        ...
        <el-button
          v-if="
            ...
            (scope.row.type === 1
              ...
              : scope.row.createUserId === userInfo.userId)
          "
          v-permission="['btn:myliveRoomlist:delLive', permsList]"
          type="text"
      ...
      <template #footer>
        <!-- <el-button
          v-permission="['btn:myliveRoomlist:restart', permsList]"
...
export default {
  ...
  data() {
    return {
      ...
      multipleSelection: [],
      bindClickKeys: ['liveModel', 'time1', 'time2'],
      teacherObj: {
        label: 'teacherName',
        value: 'teacherId'
      }
  ...
  mounted() {
    const oldFormData = getItem(`hok_mylive_formData_${this.userInfo.userId}`)
    if (oldFormData) {
    ...
    if (reload && reload === 'true') this.searchFn()
  ...
  methods: {
    ...
    setOperatorList() {
      ...
      if (
        this.permsList &&
        this.permsList.includes('btn:myliveRoomlist:addLiveRoom')
      ) {
        arr.push({
          label: '创建直播间',
          fn: () => {
    ...
    searchFn(isClear, isResetPageIndex = true) {
      ...
      setItem(
        `hok_mylive_formData_${this.userInfo.userId}`,
    ...
    getList() {
      const params = {
        ...
        createUserId: this.searhObj.createUserId,
