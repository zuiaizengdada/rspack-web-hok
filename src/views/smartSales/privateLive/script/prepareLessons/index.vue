      ...
      <div class="prepareLessons-contet">
        <div class="prepareLessons-left">
          ...
          <div class="prepareLessons-video">
            ...
            <VideoView ref="VideoView" start-time="0" :show-online-num="false" :playback-rate="[1,1.5,2]" />
          </div>
        </div>
        <div class="prepareLessons-right"><LessonContent :duration="info.videoDetail.duration" /></div>
      </div>
    </div>
  </div>
</template>
