    ...
    <div class="search-main">
      <el-form ref="form" v-model="search" class="filter-module" label-width="80px" size="small" :inline="true">
        ...
        <el-form-item label="优惠方式">
          <el-select v-model="search.discountMethod" clearable placeholder="请选择" @change="sureSearch">
            <el-option v-for="item in preferentialTypeArray" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="优惠券状态">
          <el-select v-model="search.useStatus" clearable placeholder="请选择" @change="sureSearch">
            <el-option v-for="item in useStatusArray" :key="item.value" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
  ...
  methods: {
    ...
    sureSearch() {
      if (this.orderTimeArray) {
        this.search.claimStartTime = this.orderTimeArray[0]
        this.search.claimEndTime = this.orderTimeArray[1]
      } else {
        this.search.claimStartTime = ''
        this.search.claimEndTime = ''
      }
    ...
    clear() {
      ...
      if (this.orderTimeArray) {
        res.claimStartTime = this.orderTimeArray[0]
        res.claimEndTime = this.orderTimeArray[1]
      } else {
        res.claimStartTime = ''
        res.claimEndTime = ''
      }
