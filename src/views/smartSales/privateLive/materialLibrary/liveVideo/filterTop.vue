        ...
        <el-col :span="12" class="btn-filter">
          ...
          <div>
            <el-button
              ...
              v-permission="['btn:newLiveVideo:official:uploading', permsList]"
              >上传视频</el-button
            >
          </div>
        </el-col>
    ...
    <div class="navType">
      <div class="navTypeUl">
        <div
          ...
          @click="navType === 1 ? '' : $emit('onnavTypeChange', 1)"
          v-permission="['web:newLiveVideo:official', permsList]"
        >
          正式
        </div>
        <div
          ...
          @click="navType === 2 ? '' : $emit('onnavTypeChange', 2)"
          v-permission="['web:liveDataKanbanNew:draft', permsList]"
        >
          草稿
        </div>
      </div>
