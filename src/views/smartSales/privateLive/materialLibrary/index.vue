<template>
  <MCard class="page_wrap">
    ...
    >
      ...
      <el-table-column label="视频时长" prop="duration" width="120px">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="视频转码状态" prop="covertStatus" width="130px">
        <template slot-scope="{ row }">
      ...
      <el-table-column
        ...
        width="160px"
      /> -->
      <el-table-column label="操作" prop="action" width="198px" fixed="right">
        <template slot-scope="{ row }">
          <el-button
            type="text"
            :disabled="
