    ...
    <div class="addDialog">
      ...
      >
        <el-form-item label="选择类型" prop="radio">
          ...
          >
            <el-radio :label="1">竖版图片</el-radio>
            <el-radio :label="0">横版图片</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="图片选择" prop="coverPhoto">
          <!--新增-->
          <div v-if="form.type == 1">
            ...
            <div v-if="form.coverPhoto" class="cropper-img">
              <vueCropper
                v-if="resetCropper"
                ref="cropper"
