<template>
  <div class="page_warp">
    ...
    <div :style="setRightStyle()" class="view page_warp_right">
      <filterTop :search="search" @search="searchUserFn" />
      <div class="page_wrap_right_table">
        ...
        >
          ...
          <div slot="footer" class="footer-slot">
            ...
            >批量调整部门</el-button>
            <el-button size="small" @click="setRole">批量设置角色</el-button>
            <el-button
              v-permission="['system:user:remove', permsList]"
              size="small"
              type="danger"
              @click="delUsers"
            >批量删除</el-button>
            <el-button
              v-permission="['system:user:disable', permsList]"
              size="small"
              @click="enableUsers(0)"
            >在职</el-button>
            <el-button
            ...
            >离职</el-button>
            <!-- <el-button
              v-permission="['system:user:batchPost', permsList]"
              size="small"
              @click="showPost"
            >调整岗位</el-button> -->
          </div>
          ...
          <div slot="employeeType" slot-scope="{ row }">
            <span v-if="row.employeeType === 1" class="red-cls">负责人</span>
...
import filterTop from './employee/filterTop.vue'
...
import setRoleModal from './employee/setRoleModal.vue'
import { setDeptA, setRole } from '@/api/role'
import batchAdjustPostDialog from './employee/batchAdjustPostDialog.vue'
