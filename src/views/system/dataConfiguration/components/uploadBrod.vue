...
<script>
import uploadSearch from '@/views/system/dataConfiguration/components/uploadSearch'
import brushingOrdersData from '@/views/system/dataConfiguration/components/brushingOrdersData.vue'
import offLineOrdersData from '@/views/system/dataConfiguration/components/offLineOrdersData'
import putInOrdersData from '@/views/system/dataConfiguration/components/putInOrdersData'
export default {
  name: 'UploadBrod',
  components: {
    uploadSearch,
