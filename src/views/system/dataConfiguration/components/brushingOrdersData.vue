...
import { getBrushOrderPage } from '@/api/system/dataConfiguration.js'
...
export default {
  ...
  data() {
    return {
      ...
      config: {
        ...
        tableColumns: [
          { prop: 'orderChannel', label: '渠道', width: 120, type: 'slot', visible: true, disable: true },
          ...
          { prop: 'productName', label: '第三方商品名称', type: 'text', visible: true },
  ...
  methods: {
    ...
    loadData(search) {
      ...
      getBrushOrderPage(params).then(res => {
