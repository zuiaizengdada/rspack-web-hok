  ...
  <div>
    ...
    <div class="m-t-20 clearfix">
      <div style="float:left">
        <el-button v-permission="['web:user:follower', permsList]" type="primary" :loading="modal.loading" @click="openAddModal">新增</el-button>
      </div>
...
<script>
import { userFollow, addUserFollow } from '@/api/user/member'
    ...
    addUserFollow() {
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          addUserFollow(this.form).then(res => {
