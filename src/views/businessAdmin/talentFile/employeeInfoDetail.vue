  ...
  <div class="main_content">
    ...
    <div class="main-content-container">
      <div class="main_left">
        ...
        <template v-if="['WaitingEntryList'].includes(currentComponent)">
          <div
      ...
      <template
        v-if="
          [
            ...
            'documentInfo',
            'evaluateInfo'
          ].includes(currTabName) &&
          ['WaitingEntryList'].includes(currentComponent)
        "
      >
        <div class="main_personDetailsRight" ref="scrollContainer">
          <personDetailsForm showType="employeeInfoDetail" />
        </div>
      </template>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    this.$uweb?.setAction('Event_oa_employeeInfoDetail_page')
    // 绑定滚动事件监听器
    this.$nextTick(() => {
  ...
  methods: {
    ...
    back() {
      ...
      const currentBackUrl = this.$route.query.currentBackUrl
      if (currentBackUrl) {
        this.$router.push({
          path: currentBackUrl
        })
    ...
    handleWaitingPersonFormDown() {
      this.$refs.waitingPersonFormRef?.capture()
    }
  }
}
</script>
