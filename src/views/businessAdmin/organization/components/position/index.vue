<template>
  <div class="position-managment-container">
    ...
    <div class="relative position-content">
      <!-- <p class="flex absolute" style="right: 0; top: -20px">
        <el-button
          type="primary"
          size="small"
      ...
      <p class="absolute" style="bottom: 10px; left: 0">
        <el-button type="danger" size="small" @click="handleClickBatchDelete"
          >批量删除</el-button
        >
      </p> -->
      <MPageLayout
      ...
      >
        ...
        <div slot="action" slot-scope="{ row }">
          ...
          <el-button type="text" class="red-cls" @click="handleClickDelete(row)"
            >删除</el-button
          >
        </div>
      </MPageLayout>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      slotArr: ['action', 'roleList', 'headerLeft', 'userNum'],
      config: {
        currentPage: 1,
