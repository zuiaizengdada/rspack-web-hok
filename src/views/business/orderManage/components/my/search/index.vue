  ...
  <div class="search-box">
    ...
    <div class="search-control">
      ...
      <div class="search-control-r">
        ...
        <!-- <el-button v-if="search.activeName === '全部订单' || search.activeName === '我的订单'" v-permission="['system:order:adopt', permsList]" size="small" class="control-btn" @click="onClickReceiveModel">订单认领</el-button> -->
        <span v-if="search.activeName === '全部订单' || search.activeName === '我的订单'" v-permission="['system:order:adopt', permsList]">
        ...
        <el-button v-if="search.activeName === '全部订单' || search.activeName === '我的订单'" v-permission="['system:order:receive', permsList]" size="small" class="control-btn" @click="onClickReceiveRecordModel">认领记录</el-button>
...
import receiveModel from '../../search/receiveModel.vue'
import receiveRecordModel from '../../search/receiveRecordModel.vue'
import batchReceiveModel from '../../search/batchReceiveModel.vue'
export default {
  name: 'SearchTop',
  components: {
    orderSign,
  ...
  methods: {
    ...
    onClickReceiveRecordModel() {
      this.$refs.receiveRecordModelRef.open(1)
    }
  }
}
</script>
