<template>
  <div>
    <el-form ref="form" :inline="true" :model="form" size="small">
      ...
      <el-form-item>
        <el-button :loading="btnExportLoading" size="small" @click="exportData">
          导出
        </el-button>
...
<script>
import { orderStatus, orderChannels } from '../../../../utils'
import {
  orderExport,
  orderExportTaskStatus
...
export default {
  ...
  methods: {
    ...
    getOrderExportTaskStatus(id) {
      orderExportTaskStatus({ taskId: id })
        .then(res => {
