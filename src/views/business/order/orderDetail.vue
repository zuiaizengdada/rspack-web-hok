<template>
  <div class="page_wrap">
    <div class="header">
      <span class="pointer" @click="$router.push({ path: '/business/orderManage' })">订单管理</span>
      > 订单详情
    </div>
    ...
    <div class="order-detail">
      ...
      <div class="module-item">
        ...
        <div class="module-content">
          <div class="single-line">
            ...
            <div class="info-item">
              支付方式: <span>{{ detail.paymentType | getOptionsValue(paymentType_options) }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="single-line">
            <div class="info-item">
              优惠信息: <span>{{ (detail.discountsFee || 0) | filtersMoney }}元</span>
            </div>
            <div class="info-item">
              渠道来源: <span>{{ detail.channelSource | getOptionsValue(channelSourceType) }}{{ thirdShopName }}</span>
            </div>
            <div class="info-item">
      ...
      <div class="module-item">
        ...
        <div class="module-content">
          <div class="single-line">
            <div class="info-item">
              用户ID: <span class="a_link" @click="gotoUserDetails(detail.userId)">{{ detail.userId || '--' }}</span>
            </div>
            <div class="info-item">
          ...
          <el-table-column label="商品名称" prop="goodsName">
            <template slot-scope="{ row }">
              <div class="goods-img-info">
                <div class="goods-img">
                  <ImagePreviewer :src="row.coverUrl" fit="contain" style="width: 100%; height: 100%" />
                </div>
    ...
    <!-- 新增跟进弹框 -->
    <AppDialog v-model="modal.visible" :title="modal.title" width="700px" height="400px" @success="addUserFollow">
    ...
    <!-- 售后订单详情弹框 -->
    <el-drawer title="售后订单详情" :visible.sync="AfterOrderDialog.visible" direction="rtl" size="1200px">
...
export default {
  ...
  computed: {
    ...
    thirdShopName() {
      const thirdShopName = this.detail.list && this.detail.list.length && this.detail.list[0].thirdShopName
  ...
  methods: {
    ...
    getGoodsAfterSaleList() {
      goodsAfterSaleList({ orderNo: this.$route.params.id })
        .then((res) => {
