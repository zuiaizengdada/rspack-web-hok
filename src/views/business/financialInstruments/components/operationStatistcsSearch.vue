    ...
    <div class="search-main">
      <el-form ref="form" v-model="search" class="filter-module" label-width="80px" size="small" :inline="true">
        ...
        <el-form-item label="部门">
          ...
          <!-- <el-cascader ref="cascader1" v-model="search.departmentName" :options="deptList" :props="cascaderProps" :show-all-levels="false" clearable @change="sureSearch" @clear="onhanldeDeptClear" /> -->
        </el-form-item>
...
import { getOperationExportTask, getLxUrl } from '@/api/business/financial'
export default {
  ...
  methods: {
    ...
    goodsOrderExport() {
      ...
      getOperationExportTask(this.search).then(res => {
        if (res.code === 1) {
