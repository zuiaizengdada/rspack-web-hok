<template>
  <div v-loading="loadding" class="wrapper-online-short-view" :class="itemObj.bizType === bizTypeActive?'active-show':''" @click="changeTheBizType(itemObj)">
    <div class="wrapper-top-cls">
      <div class="wrapper-top-cls-left">
        ...
        <span class="gmv-right-detail" :class="(formGmvShow.employeeDeptId && formGmvShow.chooseType === 2)?'hidden-cls':''" @click.stop="chooseBangDan(itemObj)">详情&nbsp;&nbsp;></span>
      </div>
    ...
    <!-- <div class="short-view-top ">
      <div class="gmv-left">
        <span>{{ itemObj.bizTypeName }}</span>
        <span class="gmv-left-gmv"><em />{{ itemObj.orderCount }}单</span>
      </div>
      <div class="gmv-right">
        <span :class="(formGmvShow.employeeDeptId && formGmvShow.chooseType === 2)?'hidden-cls':''" @click.stop="chooseBangDan(itemObj)">详情&nbsp;&nbsp;></span>
      </div>
    </div>
    <div class="gmv-center">
      <span class="gmv-span"><em>￥</em>{{ filterPrice(itemObj.amount) }}</span>
      <div class="gmv-center-detail">
        <span>对比{{ contrastString }}</span>
        <span class="lc">{{ filterPrice(itemObj.amountDiffer) }}</span>
        <em />
