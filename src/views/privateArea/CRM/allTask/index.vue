  ...
  <div class="page_wrap">
    ...
    >
      ...
      <template slot="action" slot-scope="{ row }">
        <el-button
          v-permission="['web:allTask:edit', permsList]"
          type="text"
          @click="openEdit(row)"
        >编辑</el-button>
        <el-button
...
export default {
  ...
  methods: {
    ...
    getDropdownList(row) {
      const dropdownList = []
      if (this.permsList.includes('web:allTask:detail')) {
        dropdownList.push({
          command: '8',
          label: '详情'
        })
      ...
      if (
        this.permsList.includes('web:allTask:copy') &&
      ...
      if (
        this.permsList.includes('web:allTask:close') &&
      ...
      if (
        this.permsList.includes('web:allTask:stop') &&
      ...
      if (
        this.permsList.includes('web:allTask:restart') &&
      ...
      if (
        this.permsList.includes('web:allTask:live') &&
        row.isLive
      ) {
        dropdownList.push({
          command: '6',
      ...
      if (this.permsList.includes('web:allTask:kanban') && row.dataType !== 4) {
        dropdownList.push({
          command: '7',
          label: '看板'
        })
      }
      if (this.permsList.includes('web:allTask:log')) {
        dropdownList.push({
          command: '9',
          label: '日志'
        })
      ...
      if (
        this.permsList.includes('web:allTask:delete') &&
        row.taskStatus === '4'
      ) {
        dropdownList.push({
          command: '3',
