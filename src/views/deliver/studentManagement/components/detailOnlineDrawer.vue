    ...
    <div v-if="visible" v-loading="loading" class="drawerBody">
      ...
      <div class="drawerContent overflowOuto">
        <div class="detailForm">
          ...
          <div class="detailFormView">
            <div class="detailFormLabel">累计时长：</div>
            <div class="detailFormValue">
        ...
        <div v-if="!loading" class="tabView">
          ...
          <components
            :is="activeName"
            :delivery-info-id="detailForm.deliveryNo"
            :delivery-no="detailForm.deliveryNo"
...
import runningRecordedLog from './runningRecordedLog'
import signLog from './signLog.vue'
import watchLog from './watchLog.vue'
import studentDynamics from './studentAIInfo/studentDynamics.vue'
...
import { getDeliveryOnlineInfo } from '@/api/deliver/studentManagement'
export default {
  components: {
    basicInfoLog,
    runningRecordedLog,
  ...
  methods: {
    ...
    getDeliveryOnlineInfo() {
      this.loading = true
      getDeliveryOnlineInfo({ id: this.id })
        .then(res => {
          this.loading = false
          this.detailForm = {
            ...this.detailForm,
