<template>
  ...
  <div class="upload">
    <el-upload
      ...
      action="#"
      :limit="1"
      accept=".mp3,.wav,.aac,.3pg,.mar,.wma,.3pg,.mp4,.mov,.jpg,.png,.jpeg,.bmp"
...
export default {
  ...
  data() {
    return {
      tips: '最少上传1个文件,最多上传6个文件,文件格式只限<br/>音频(mp3/wav/aac/3pg/mar/wma),单个音频不能大于10M<br/>视频(3pg/mp4/mov),单个视频不能大于20M<br/>图片(jpg,png,jpeg,bmp),单个图片文件不能大于3M',
      ossConfig: {
        region: '',
        accessKeyId: '',
        accessKeySecret: '',
