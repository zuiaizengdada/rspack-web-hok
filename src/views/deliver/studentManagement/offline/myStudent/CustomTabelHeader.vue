<template>
  <el-popover
    ...
    trigger="click"
  >
    <p slot="reference" style="color:#0C6FFF;font-size:14px;line-height: 36px;" class="cursor-pointer flex items-center"><img :src="iconShezhi" class="mr-1" style="margin-top:2px;" />自定义表头</p>
...
export default {
  ...
  mounted() {
    ...
    this.$dragging.$on('dragged', (res) => {
      console.log(res)
      localStorage.setItem('tableColumns_deliverMystudentColumns4', JSON.stringify(this.columns))
