    ...
    >
      ...
      <template slot="action" slot-scope="{ row }">
        ...
        <el-button
          ...
          :disabled="['已关闭', '锁定交付'].includes(row.deliveryStatusName)"
          type="text"
        ...
        >调班</el-button>
        <el-button v-permission="['web:allRecorded:call', permsList]" type="text" @click="call(row)">呼叫</el-button>
      </template>
