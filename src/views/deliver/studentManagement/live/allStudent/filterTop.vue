  ...
  <div class="filterTop">
    <el-form ref="form" :model="search" label-width="auto" size="small">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-form-item label="入班状态">
            <el-select
              v-model="search.joinClassStatus"
              placeholder="请选择"
            >
              <el-option label="全部" value="" />
              <el-option label="已入班" :value="1" />
              <el-option label="未入班" :value="2" />
            </el-select>
          </el-form-item>
        </el-col>
        <!-- <el-col :span="6">
      ...
      <el-row type="flex" class="mb-4" justify="end">
        <el-col :span="6" class="flex justify-end">
          ...
          <el-button v-permission="['web:allRecorded:call', permsList]" size="small" type="primary" @click="openCall()">
            呼叫
          </el-button>
        </el-col>
      </el-row>
