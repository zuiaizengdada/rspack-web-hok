  ...
  <div class="filter-module">
    ...
    <el-form ref="form" :model="search" label-width="66px" size="small" :inline="true">
      ...
      <el-form-item label="成本核算">
        <el-select v-model="search.costCheckStatus" placeholder="请选择" style="width: 200px" clearable :disabled="search.scheduleStatus === '1' || search.scheduleStatus === '2'">
    ...
    <div class="addView">
      <el-button size="small" type="primary" @click="$emit('handleClickAdd')">新增班期</el-button>
    </div>
  </div>
</template>
    ...
    async remoteMethod(query) {
      ...
      try {
        const { data } = await getDeliveryScheduleList(
          { size: 90, current: 1, goodsId: this.search.goodsId, matchScheduleNum: query }
        )
