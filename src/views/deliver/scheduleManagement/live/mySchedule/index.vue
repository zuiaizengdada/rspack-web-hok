  ...
  <div class="page_wrap">
    ...
    >
      ...
      <div slot="action" slot-scope="{ row }">
        <el-button
          v-permission="['web:myClass:detail', permsList]"
          type="text"
          @click="handleClickDetail(row)"
        >详情</el-button>
        <el-button
          v-permission="['web:myClass:edit', permsList]"
          type="text"
          @click="handleClickEdit(row)"
        >编辑</el-button>
        <!-- v-permission="['web:mySchedule:signLog', permsList]" -->
        <el-button
          v-permission="['web:myClass:copy', permsList]"
          type="text"
          @click="handleClickCopy(row)"
        >复制</el-button>
        <el-button
          v-permission="['web:myClass:share', permsList]"
          type="text"
...
import { getScheduleMyPage } from '@/api/deliver/scheduleManagement'
  ...
  methods: {
    ...
    async getList(flag) {
      ...
      try {
        ...
        const { data } = await getScheduleMyPage(params)
