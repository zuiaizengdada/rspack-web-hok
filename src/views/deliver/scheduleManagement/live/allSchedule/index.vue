  ...
  <div class="page_wrap">
    ...
    >
      ...
      <div slot="action" slot-scope="{ row }">
        <el-button
          v-permission="['web:allClass:detail', permsList]"
          type="text"
          @click="handleClickDetail(row)"
        >详情</el-button>
        <el-button
          v-permission="['web:allClass:edit', permsList]"
          type="text"
        ...
        <el-button
          v-permission="['web:allClass:share', permsList]"
          type="text"
  ...
  methods: {
    ...
    async getList(flag) {
      try {
        ...
        const { data } = await getDeliveryScheduleList(params)
