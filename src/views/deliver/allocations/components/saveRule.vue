  ...
  methods: {
    ...
    async handleSave() {
      ...
      await addWarehouse({
        ...
        settingId: this.config.id,
        allocationRules: this.config.allocationRules,
        assistantUserId: this.config.assistantUserId,
        assistantUserName: this.config.assistantUserName
      })
