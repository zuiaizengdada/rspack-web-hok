<template>
  <div class="allHeader">
    <div class="headerTop">
      <MTitle>
        数据概况
        <el-tooltip class="item" effect="dark" content="课程金额小于1000元订单汇总" placement="top-start">
...
import { getDiversionDataInfo } from '@/api/deliver/deliverStatistics'
...
export default {
  ...
  data() {
    return {
      ...
      dataCourceList: [
        { id: 1, prop: 'recruitItem', key: '招生', title: '总招生金额', tips: '所选时间段内课程价格小于1000元的子订单付款金额汇总减去课程价格小于1000元的子订单已退款金额汇总<br/>按订单付款时间', number: 0, arr: ['', ''] },
        { id: 2, prop: 'deliveredFeeItem', key: '交付', title: '总交付金额', tips: '等于总招生金额', number: 0, arr: ['', ''] },
        { id: 3, prop: 'refundedItem', key: '退款', title: '总退款金额', tips: '所选时间段内已退款总金额(按退款通过时间统计)', number: 0, arr: ['', ''] }
      ],
      params: {
        deliveryFlag: 2 // 1交付 2导流
      },
      tabList: [
        { id: '3', name: '普通专栏', api: '' },
        // { id: '6', name: '直播专栏', api: '' },
  ...
  methods: {
    ...
    getTabList() {
      ...
      getDiversionDataInfo(params).then(res => {
        console.log(res)
