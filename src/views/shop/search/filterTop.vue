      ...
      <el-form ref="form" class="filter-module" :model="search" label-width="80px" size="small" :inline="true">
        <el-row>
          ...
          <el-form-item label="是否推荐">
            <el-select v-model="search.recommendFlag" placeholder="请选择" class="w-200" clearable @clear="sureSearch">
          ...
          <el-form-item label="来源">
            <el-select v-model="search.searchSource" placeholder="请选择" class="w-200" clearable @clear="sureSearch">
              <el-option label="后端运营" :value="1" />
              <el-option label="前端客户" :value="2" />
            </el-select>
          </el-form-item>
        </el-row>
        ...
        <el-row type="flex" justify="end">
          <el-form-item>
            ...
            <el-button icon="el-icon-refresh" :loading="search.loading" @click="clear()">清空</el-button>
          </el-form-item>
        </el-row>
      </el-form>
    </div>
