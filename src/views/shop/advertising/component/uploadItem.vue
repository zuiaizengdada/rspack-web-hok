    ...
    <div class="image_poster">
      ...
      >
        ...
        <transition name="slide">
          <div v-show="alignUploadShow" class="alignUploadShow">
      ...
      <div v-else class="image_poster">
        <slot name="uploadShow" :row="url">
          <uploadShow :accept="accept" :before-upload="beforeUpload" :url="url" style="width: 100%; height: 100%" @upload="(e) => $emit('upload', e)" />
        </slot>
      </div>
    </div>
    <!-- <slot name="del">
