  ...
  <div class="content">
    <div class="content_header">
      <div class="header_left">
        <el-button v-permission="['system:grouping:relation:add', $route.meta.permsList]" type="primary" @click="selectGoods()">添加商品</el-button>
      </div>
      <!-- <div class="header_right">
        ...
        <el-input v-model.trim="contentName" class="w-200 m-l-10 m-r-10" placeholder="请输入商品名称" />
    ...
    <div class="content_table">
      ...
      <el-row>
        <el-col :span="12">
          <el-button v-permission="['system:group:remove', $route.meta.permsList]" class="m-t-20" @click="allDisassociateBatch()">批量移出</el-button>
        </el-col>
        <el-col :span="12">
          <el-pagination
            class="pagination"
...
export default {
  ...
  methods: {
    ...
    getList() {
      const params = {
        groupingId: this.$route.params.id,
