    ...
    <div class="contentList">
      <div class="content_header">
        <div class="header_left">
          <el-button
            v-permission="[
              'system:grouping:relation:add',
              $route.meta.permsList
            ]"
            type="primary"
            @click="selectGoods()"
          >添加商品</el-button>
      ...
      <div class="content_table">
        ...
        >
          ...
          <el-table-column label="操作" width="180">
            <template slot-scope="{ row }">
              <el-button
                v-permission="['web:groupDetail:edit', $route.meta.permsList]"
                type="text"
                @click="gotoEdit(row)"
              >编辑</el-button>
              <el-button
                v-permission="['system:group:remove', $route.meta.permsList]"
                type="text"
