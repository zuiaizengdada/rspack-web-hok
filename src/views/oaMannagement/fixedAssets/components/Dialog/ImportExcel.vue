  ...
  >
    <div slot="content" class="import-container">
      ...
      <p style="margin: 10px 0">
        <a
          href="https://oss.hokkj.cn/edata-oa/export/%E5%9B%BA%E5%AE%9A%E8%B5%84%E4%BA%A7%E5%AF%BC%E5%85%A5%E6%A8%A1%E6%9D%BF.xlsx"
          style="color: #0c6fff"
          >下载模板</a
        >
      </p>
...
import { assetImport } from '../../../api/assets.js'
...
export default {
  ...
  methods: {
    handleClickSubmit() {
      ...
      this.$uweb?.setAction('Event_oa_fixedAsset_import')
      this.source = this.CancelToken.source()
      const formData = new FormData()
      formData.append('file', this.fileList[0])
      this.loading = true
      assetImport(formData, this.source.token)
        .then(res => {
          if (res.code === 1) {
            this.tips = {
