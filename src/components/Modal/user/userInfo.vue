  ...
  <div v-loading="loading" :class="`group${type == 2 ? 'Dialog' : 'Drawer'}`">
    <div class="form">
      <div class="page_header">
        <div>
          <!-- <span class="pointer" @click="$router.push({ path: `/system/member` })"><用户列表/span>
          <span class="m-l-10 m-r-10">/</span>
          <span>用户详情</span> -->
        </div>
        <div class="fl">
          <el-button v-permission="['user:edit', permsList]" class="header_Detail m-l-20" @click="openDetailEdit">编辑资料</el-button>
        </div>
      </div>
      ...
      <div class="page_user_info m-t-20">
        <el-row class="w-100p customer-info-content">
            ...
            <div class="fl w-100p">
              ...
              <div class="m-l-20 w-100p">
                ...
                <div class="customer-info-list">
                  ...
                  <div>
                    <span>手机号:</span>
                    <span>{{ detail.phone }} <i v-if="detail.phone.indexOf('xxxx') > 0 || detail.phone.indexOf('XXXX') > 0" class="pointer el-icon-view" @click="toShowPhoneNumber" /></span>
                  </div>
                  <div>
                    <span> 来源:</span>
                    <span>
          ...
          <el-col :span="9">
            <div class="customer-transaction">
              <div class="customer-title">交易统计</div>
        ...
        <div class="customer-info-more">
          <div class="customer-info-more__box customer-info-remark">
            ...
            <el-popover v-model="editRemakeVisible" placement="left-start" title="备注" width="500" trigger="click">
              ...
              <div class="m-t-10 user-popover-content__foot">
                <el-button @click="editRemakeVisible = false">取消</el-button>
        ...
        <div class="w_100p">
          ...
          <components :is="activeName" :id="userId" :data="detail.goodsOrderDetailVoList" />
        </div>
      </div>
      ...
      >
        <div v-loading="detailFormLoading" class="choose_resource m-t-20 p-10">
          <el-form ref="detailForm" :model="detailForm" label-width="80px" :inline="true">
            ...
            <el-form-item label="职位" prop="position">
              <el-select v-model="detailForm.position" placeholder="请选择">
...
import { Detail, userEdit, userLabelDisassociate, userLabelBatch, queryPhoneNumberByUid } from '@/api/user/member'
import openRecord from '@/views/system/member/openRecord.vue'
import learningData from '@/views/system/member/learningData.vue'
import userFollow from '@/views/system/member/userFollow.vue'
import virtualCurrency from '@/views/system/member/virtualCurrency/index.vue'
