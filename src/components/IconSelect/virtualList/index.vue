<template>
  <div :id="`${idName}_IconSelectConfiguration`" ref="list" :style="{height}" class="infinite-list-container" @scroll="scrollEvent($event)">
...
export default {
  ...
  methods: {
    ...
    // 滚动到节点
    scrollTo(index, fn) {
      const idName = `${this.idName}_IconSelectConfiguration`
      ...
      // console.log(el, i)
      // console.log(this.visibleCount, this.aboveCount, this.belowCount, '滚动触发')
