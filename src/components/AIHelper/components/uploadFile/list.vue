<template>
  <div class="fileListView">
    <img v-if="['xls', 'xlsx', 'cvs', 'xlsm'].includes(imgType)" src="@/assets/image/pdf.png" fit="contain" class="size-icon">
    <img v-else-if="['ppt', 'pptx'].includes(imgType)" src="@/assets/image/ppt.png" fit="contain" class="size-icon">
    <img v-else-if="['doc', 'docx', 'pdf'].includes(imgType)" src="@/assets/image/ppt2.png" fit="contain" class="size-icon">
    <img v-else-if="['word'].includes(imgType)" src="@/assets/image/word.png" fit="contain" class="size-icon">
    <img v-else-if="['txt'].includes(imgType)" src="@/assets/image/txt.png" fit="contain" class="size-icon">
    ...
    <div class="fileBtn">
      ...
      <div class="fileBtnIcon">
        <div v-if="alignUploadShow2" class="preview">删除</div>
        <img src="@/assets/image/aigc/aiDel.png" @click="$emit('del')" @mouseenter="alignUploadShow2 = true" @mouseleave="alignUploadShow2 = false">
      </div>
    </div>
  </div>
</template>
