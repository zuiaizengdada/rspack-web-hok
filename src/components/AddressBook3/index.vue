          ...
          <template v-if="isShowSelect">
            <div class="inherit_select">
              ...
              <m-select
                ...
                size="mini"
              />
              <template v-if="qwInheritType === 1">
                <div style="margin: 0 10px">且</div>
                <el-select
                  v-model="qwInheritDelayType"
                ...
                <el-input-number
                  v-if="qwInheritDelayType !== '1'"
                  v-model="qwInheritDelayDay"
                  size="mini"
      ...
      if (this.success) {
        ...
        const objData = this.isShowSelect
          ? {
            ...
            qwInheritDelayDay:
                this.qwInheritDelayType === '1' ? 0 : this.qwInheritDelayDay
          }
          : {
            dept: this.checkDept,
            user: this.checkUser
